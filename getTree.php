<?php
    ...
    foreach ($faculties as $faculty) {
        $sqlDepartment = file_get_contents("sqlRequests/sqlGetDepartment.txt");
        ...
        foreach ($faculties[$faculty['faculty_id'] - 1]['department'] as &$departmentNew) {
            $sqlGroup = file_get_contents("sqlRequests/sqlGetGroup.txt");
            ...
            foreach ($departmentNew['groups'] as &$groupNew) {
                $sqlStudents = file_get_contents('sqlRequests/sqlGetStudents.txt');
